package com.plurasight.DealershipRESTAPI.cli.menu;


import com.plurasight.DealershipRESTAPI.dao.AllContractsDaoImpl;
import com.plurasight.DealershipRESTAPI.dao.LeaseContractDaoImpl;
...
import com.plurasight.DealershipRESTAPI.models.*;
...
public class UserInterface {
    ...
    private final AllContractsDaoImpl allContractDataManager;
    private final LeaseContractDaoImpl leaseContractManager;
    private final SaleContractDAO saleContractManager;

    @Autowired
    public UserInterface(DealerShipDataManager dealerShipFileManager, AllContractsDaoImpl contractDataManager, LeaseContractDaoImpl leaseContractManager, SaleContractDAO saleContractManager) {
        this.dealerShipFileManager = dealerShipFileManager;
        this.dealership = dealerShipFileManager.getDealership();
        this.allContractDataManager = contractDataManager;
        this.leaseContractManager = leaseContractManager;
...
//        System.out.println(Dealership.GetVehiclesByPrice(min, max));
        ...
        while (true) {
            ...
            if (opt.equalsIgnoreCase("lease")) {
                ...
                if (addOtherCont.equalsIgnoreCase("no")) {
                    leaseContractManager.saveContract(lease);
                    break;
                } else {
                    return;
                }
                ...
                if (addOtherCont.equalsIgnoreCase("no")) {
                    saleContractManager.saveContract(sale);
                    break;
                } else {
                    return;
                }
    ...
    public void contractScreen() {
        allContractDataManager.getContracts(dealership);
